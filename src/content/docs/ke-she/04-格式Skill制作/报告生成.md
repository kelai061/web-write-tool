...
- **AI 脑力日志**：
  - [Skill-AI 执行计划](/ke-she/04-格式skill制作/引用文件/gemini日志/排版计划/)
  - [Skill-AI 工作日志](/ke-she/04-格式skill制作/引用文件/gemini日志/排版日志/)
...
相关资料：
- **学生乙测试 AI 执行计划**：[课设正式测试-计划](/ke-she/04-格式skill制作/引用文件/gemini日志/测试计划/)
